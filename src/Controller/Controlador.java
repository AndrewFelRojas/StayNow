...
public class Controlador {
    ...
    public void guardarDatosCSV() {
        ClienteLoader.guardarClientes("clientes.txt", clientes);
        AlojamientoLoader.guardarAlojamientos("alojamientos.txt", alojamientos);
        ReservaLoader.guardarReservas("reservas.txt", reservas);
    ...
    private void cargarDatosCSV() {
        try {
            this.clientes = ClienteLoader.cargarClientes("clientes.txt");
            System.out.println("Clientes cargados: " + clientes.size());
        } catch (ArchivoNoEncontradoException e) {
            System.out.println(e.getMessage() + " - Se creará uno nuevo");
        }
        try {
            this.alojamientos = AlojamientoLoader.cargarAlojamientos("alojamientos.txt");
            System.out.println("Alojamientos cargados: " + alojamientos.size());
        } catch (ArchivoNoEncontradoException e) {
            System.out.println(e.getMessage() + " - Se creará uno nuevo");
        }
        try {
            this.reservas = ReservaLoader.cargarReservas("reservas.txt", clientes, alojamientos);
